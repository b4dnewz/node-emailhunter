(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("http"), require("https"), require("url"), require("assert"), require("stream"), require("tty"), require("util"), require("fs"), require("net"), require("zlib"), require("querystring"));
	else if(typeof define === 'function' && define.amd)
		define(["http", "https", "url", "assert", "stream", "tty", "util", "fs", "net", "zlib", "querystring"], factory);
	else if(typeof exports === 'object')
		exports["EmailHunter"] = factory(require("http"), require("https"), require("url"), require("assert"), require("stream"), require("tty"), require("util"), require("fs"), require("net"), require("zlib"), require("querystring"));
	else
		root["EmailHunter"] = factory(root["http"], root["https"], root["url"], root["assert"], root["stream"], root["tty"], root["util"], root["fs"], root["net"], root["zlib"], root["querystring"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_26__, __WEBPACK_EXTERNAL_MODULE_27__, __WEBPACK_EXTERNAL_MODULE_32__, __WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_34__, __WEBPACK_EXTERNAL_MODULE_35__, __WEBPACK_EXTERNAL_MODULE_36__, __WEBPACK_EXTERNAL_MODULE_45__) {
...
var _leads = __webpack_require__(46);

var _leads2 = _interopRequireDefault(_leads);

var _leads_list = __webpack_require__(47);
...
var API_ENDPOINT = 'https://api.hunter.io/v2';

// Clear object from properties with empty values
var clean = function clean(object) {
...
var EmailHunter = function () {
  ...
  _createClass(EmailHunter, [{
    ...
    value: function run(_ref) {
      ...
      var apiKey = _querystring2.default.stringify({ api_key: this.apiKey });

      // The xhr request object
      var req = null;

      // Basic url
      var url = API_ENDPOINT + '/' + type + '/' + id + '?' + apiKey;
      ...
      switch (action) {
        case 'POST':
          req = _axios2.default.post(url, options);
          break;
        case 'PUT':
          req = _axios2.default.put(url, options);
          break;
        case 'DELETE':
          req = _axios2.default.delete(url);
          break;
        default:
          if (query) {
            url += '&' + query;
          }
          req = _axios2.default.get(url);
          break;
      }
    ...
    key: 'emailVerifier',
    value: function emailVerifier(email, callback) {
      var options = (typeof email === 'undefined' ? 'undefined' : _typeof(email)) === 'object' ? email : { email: email };
      return this.run({
        type: 'email-verifier',
        options: options,
        callback: callback
    ...
    key: 'emailCount',
    value: function emailCount(domain, callback) {
      var options = (typeof domain === 'undefined' ? 'undefined' : _typeof(domain)) === 'object' ? domain : { domain: domain };
      return this.run({
        type: 'email-count',
        options: options,
        callback: callback
    ...
    key: 'domainSearch',
    value: function domainSearch(options, callback) {
      return this.run({
        type: 'domain-search',
        options: options,
        callback: callback
